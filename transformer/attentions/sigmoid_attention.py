...
class SigVAttention(nn.Module):
    """
    compute Sigmoid Value Attention
    ...
    def __init__(self):
        super(SigVAttention, self).__init__()
        self.softmax = nn.Softmax(dim=-1)
        print(f"Using Sigmoid Value Attention")
