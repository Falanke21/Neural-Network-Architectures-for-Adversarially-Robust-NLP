...
if __name__ == "__main__":
    ...
    arg_parser.add_argument("rootdir", help="Root directory of the model architecture")
    ...
    for head in HEAD_CONFIGS:
        ...
        with open(result_file, "r") as f:
            ...
            print(f"Heads: {head}, std_acc: {std_acc}, acc_under_attack: {acc_under_attack}, sum_acc: {sum_acc}")
